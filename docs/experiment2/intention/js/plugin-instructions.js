var jsPsychInstructions = (function (jspsych) {
  ...
  class InstructionsPlugin {
      ...
      trial(display_element, trial) {
          ...
          var key_backward = 'ArrowLeft';
          var key_forward = 'ArrowRight';
          ...
          const after_response = (info) => {
              ...
              if (this.jsPsych.pluginAPI.compareKeys(info.key, key_backward)) {
                  if (current_page !== 0) {
                      back();
                  }
              }
              if (this.jsPsych.pluginAPI.compareKeys(info.key, key_forward)) {
                  next();
              }
          };
          show_current_page();
