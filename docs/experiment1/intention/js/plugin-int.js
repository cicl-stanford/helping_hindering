var judgeIntention = (function (jsPsych) {
    'use strict';

    const info = {
        name: 'judge-intention',
        parameters: {
            trial: {
    ...
    class JudgeIntentionPlugin {
        constructor(jsPsych) {
            this.jsPsych = jsPsych;
        }
        trial(display_element, trial) {
            var slider_width = 500;
            var slider_labels = ['definitely hinder <br> the red player',
                                 'unsure',
                                 'definitely help <br> the red player'];
            ...
            html += '<p> What was the blue player intending to do? </p>';
            ...
            html += '<button id="jspsych-html-slider-response-next" style="margin: 2em 1em 3em 1em;" class="jspsych-btn" disabled>'+button_label+'</button>';
    ...
    JudgeIntentionPlugin.info = info;

    return JudgeIntentionPlugin;
