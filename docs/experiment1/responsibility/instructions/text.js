...
// 5em (jspsych 1em = 18px) + height of trial images
...
var page4 = starter_short +
        ...
        // double-quoted string: text below contains an apostrophe
...
var instructions_last = '<p> In this experiment, we will show you scenarios' +
        ...
        ' the star in time. We want to know how responsible you think the' +
        " blue player is for the red player's success or failure.</p>";
...
var start_prompt1 = '<p> Correct! You will now see 30 different scenarios featuring' +
