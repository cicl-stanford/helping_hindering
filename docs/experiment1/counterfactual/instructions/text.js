...
// height = 5em + trial image height (jspsych font: 1em = 18px)
...
var instructions_last = '<p> In this experiment, we will show you scenarios' +
        ...
        ' the star in time. We want to know how likely you think the red' +
        ' player would have (or would still have) succeeded if the blue' +
        " player hadn't been there. </p>";
