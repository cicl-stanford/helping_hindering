var judgeEffort = (function (jsPsych) {
    'use strict';
    ...
    class JudgeEffortPlugin {
        ...
        trial(display_element, trial) {
            ...
            html += '<p> How much effort did the blue player exert? </p>';
    ...
    JudgeEffortPlugin.info = info;

    return JudgeEffortPlugin;
