...
// = 5em + trial image height (jspsych font: 1em = 18px)
...
var starter_ex = starter_short + '<h3 style="margin-bottom: -10px;"> Example Round </h3> <p> Player A: ' + red(ex_red_name) + ', Player B: ' + blue(ex_blue_name) + '</p> <img src="trials/0/';
...
var pageE1 = starter_ex + '00' + end_ex +
        "<p> As an example, let's watch one round of the game between " 
        + red(ex_red_name) + ', Player A, and ' + blue(ex_blue_name) + ', Player B.' +
        ' The number of timesteps remaining is shown on the right.' +
        ' </p> <p> Player A always goes first. <br> <br>' +
...
var instructions_last = '<p> In this experiment, we will show you several trials' +
        ' where a different Player A and Player B play <b>two rounds</b> of this game.' +
        ' At the end of each round, Player A either succeeds or fails to reach the star in time.' +
        ' </p> <p> After Round 1, we want to know what you think Player A should do in Round 2.' + 
        ' After Round 2, we want to know whether you think Player B is a helper or a hinderer, and how' +
        ' responsible you think each player was for the success or failure. </p>';
...
var comprehension5 = '<p> Player A and Player B will play two rounds of the game. </p>';
var options5 = ['True', 'False'];
                    
var start_prompt1 = '<p> Correct! You will now see several trials. In each one, a' +
        ' different Player A and Player B will play two rounds of the game. </p>' +
        '<p> For each round, you will first get to walk through a step-by-step' +
        ' play of what happened on each timestep. You can proceed by either clicking' +
...
var start_prompt2 = '<p> Remember, the goal of <b>Player A</b> is to' +
        ...
        ' In each trial, the players will play <b>two rounds</b> of the game.' + 
