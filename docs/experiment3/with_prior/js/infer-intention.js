...
jsPsych.plugins['infer-intention'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
      ...
      // display t1 gif while answering intention question
      html += '</h3><p style="margin-bottom: -10px;">' + trial.footer + '</p>';
      html += '<h4> Round 1 </h4>';
      html += '<img src="trials/' + trial.trial + '/t1/full.gif"></img>';

      // add intention question
      html += '<p> Now that you have seen Round 1, do you think ' + blue(trial.blue_name) + ' is a hinderer or a helper?</p> </div>';
      ...
      html += '<p style="margin-top: 100px; margin-bottom: -10px;"> Click Continue to see what happens in Round 2. </p> </div>';
