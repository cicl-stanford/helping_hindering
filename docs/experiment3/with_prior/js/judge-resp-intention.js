...
jsPsych.plugins['judge-resp-intention'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.trial == 0) {
      ...
      html += '<div> <p style="flex: 1; margin-top: -10px; width: 390px; opacity: 0.6; font-size: 60%"> What should <b><span style="color:rgb' + trial.red_display + ';">' + trial.red_name + '</span></b> do in Round 2? </p>';
    ...
    if (trial.trial == 0) {
      html += '<div style="margin-top: 1.5em; margin-bottom: 0.6em; font-size: 80%"><p>Now that you have seen this trial, do you think ' + blue(trial.blue_name) + ' is a hinderer or a helper?</p></div>';
    }
    else {
      html += '<div style="margin-top: 1.5em; margin-bottom: 0.6em; font-size: 80%"><p>Now that you have seen this trial, do you think <b><span style="color:rgb' + trial.blue_display + ';">' + trial.blue_name + '</span></b> is a hinderer or a helper?</p></div>';
    }
